...
public partial class App : Application
{
    ...
    public IServiceProvider BuildServiceProvider()
    {
        ...
        // Note: for openiddict to work properly on desktop
        // we need to listen to the ApplicationStopping event and exit the application
        // otherwise URL activation upon login/logout causes another application window to open
